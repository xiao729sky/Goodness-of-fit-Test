...
######   return loglik
loglik <- function(para, u, status1, status2, copula) {
...
######   return sum(loglik)
loglik_sum <- function(para, u, status1, status2, copula) {
  ...
  logL_sum <- sum( term1 + term2 + term3 + term4 )
  
  return(logL_sum)
}

######   return loglik_out
loglik_out <- function(para, u, status1, status2, copula) {
